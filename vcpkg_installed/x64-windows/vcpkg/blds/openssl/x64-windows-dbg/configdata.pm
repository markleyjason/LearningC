...
our %config = (
    "AR" => "C:\\Program Files\\Microsoft Visual Studio\\2022\\Community\\VC\\Tools\\MSVC\\14.38.33130\\bin\\Hostx64\\x64\\lib.exe",
    "ARFLAGS" => [
        "-machine:x64 -nologo"
    ],
    ...
    "PERL" => "C:\\Users\\markl\\AppData\\Local\\vcpkg\\downloads\\tools\\perl\\5.32.1.1\\perl\\bin\\perl.exe",
    "RC" => "rc",
    "RCFLAGS" => [],
    "afalgeng" => "",
    "api" => "30100",
    ...
    "perl_cmd" => "C:\\Users\\markl\\AppData\\Local\\vcpkg\\downloads\\tools\\perl\\5.32.1.1\\perl\\bin\\perl.exe",
    "perl_version" => "5.32.1",
    "perlargv" => [
