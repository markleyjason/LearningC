...
our %config = (
    ...
    "CFLAGS" => [
        "  -nologo -DWIN32 -D_WINDOWS -utf-8 -MP  -D_DEBUG -MDd -Z7 -Ob0 -Od -RTC1  "
    ],
    "CPP" => "\$(CC) /EP /C",
    "CPPDEFINES" => [],
    "CPPFLAGS" => [],
    ...
    "LDFLAGS" => [
        " -machine:X86 -nologo    -debug -INCREMENTAL "
    ],
    "LDLIBS" => [],
    "MT" => "mt",
    "MTFLAGS" => [
    ...
    "perlargv" => [
        ...
        "VC-WIN32",
        "--debug",
        "--prefix=C:\\Users\\markl\\source\\repos\\LearningC\\vcpkg_installed\\x86-windows\\vcpkg\\pkgs\\openssl_x86-windows\\debug",
        "--openssldir=C:\\Users\\markl\\source\\repos\\LearningC\\vcpkg_installed\\x86-windows\\vcpkg\\pkgs\\openssl_x86-windows\\debug",
        "AS=C:\\Users\\markl\\AppData\\Local\\vcpkg\\downloads\\tools\\nasm\\nasm-2.16.03\\nasm.exe",
        "CC=C:\\Program Files\\Microsoft Visual Studio\\2022\\Community\\VC\\Tools\\MSVC\\14.43.34808\\bin\\Hostx64\\x86\\cl.exe",
        "CFLAGS=  -nologo -DWIN32 -D_WINDOWS -utf-8 -MP  -D_DEBUG -MDd -Z7 -Ob0 -Od -RTC1  ",
        "AR=C:\\Program Files\\Microsoft Visual Studio\\2022\\Community\\VC\\Tools\\MSVC\\14.43.34808\\bin\\Hostx64\\x86\\lib.exe",
        "ARFLAGS=-machine:X86 -nologo",
        "LD=C:\\Program Files\\Microsoft Visual Studio\\2022\\Community\\VC\\Tools\\MSVC\\14.43.34808\\bin\\Hostx64\\x86\\link.exe",
        "LDFLAGS= -machine:X86 -nologo    -debug -INCREMENTAL "
    ],
    "perlenv" => {
        "AR" => undef,
        "ASFLAGS" => undef,
...
unless (caller) {
    ...
    use lib 'C:/Users/markl/source/repos/LearningC/vcpkg_installed/x86-windows/vcpkg/blds/openssl/x86-windows-dbg/util/perl';
    use OpenSSL::fallback 'C:/Users/markl/source/repos/LearningC/vcpkg_installed/x86-windows/vcpkg/blds/openssl/x86-windows-dbg/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib 'C:/Users/markl/source/repos/LearningC/vcpkg_installed/x86-windows/vcpkg/blds/openssl/x86-windows-dbg/Configurations';
        use gentemplate;
