# 1 "C:/Users/markl/source/repos/LearningC/vcpkg_installed/x86-windows/vcpkg/blds/lapack-reference/src/v3.11.0-5e6de67bfb.clean/SRC/claunhr_col_getrfnp2.f"
# 1 "<built-in>"
# 1 "<command-line>"
